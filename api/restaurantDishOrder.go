...
func AdvancedRestaurants(c *gin.Context) {
	...
	// TODO: SQL Prepare
	sqlStr := "SELECT RestaurantID, RestaurantName, avgPrice " +
		"FROM restAvgPrice " +
		"WHERE ZipCode >= ? AND ZipCode <= ? AND avgPrice >= ? " +
		"ORDER BY avgPrice DESC " +
		"LIMIT ?;"
	fmt.Println("The table restAvgPrice is generated by stored procedure restAvgPrice()")
	fmt.Println(sqlStr)
